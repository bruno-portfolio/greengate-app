const translations = {
    pt: {
        ...
        src_deter_name: 'DETER',
        src_deter_desc: 'Alertas de desmatamento em tempo real',
        src_mapbiomas_name: 'MapBiomas Alerta',
        src_mapbiomas_desc: 'Alertas de desmatamento por satélite',
        ...
        src_queimadas_name: 'Queimadas',
        src_queimadas_desc: 'Focos de calor por satélite',
        src_hidro_name: 'Hidrografia',
        src_hidro_desc: 'APP de recursos hídricos (30m buffer)',
        src_floresta_name: 'Florestas Públicas',
        src_floresta_desc: 'Cadastro Nacional de Florestas Públicas',
        src_concessao_name: 'Concessões Florestais',
        src_concessao_desc: 'Áreas de concessão florestal',
        src_sicar_name: 'CAR/SICAR',
        src_sicar_desc: 'Cadastro Ambiental Rural',
        src_pivos_name: 'Pivôs de Irrigação',
        src_pivos_desc: 'Mapeamento de pivôs centrais',
        ...
        method_process_desc: 'PostGIS + 13 camadas',
        ...
        method_step2_detail: 'PostGIS cruza contra 13 bases oficiais simultaneamente.',
    ...
    en: {
        ...
        src_deter_name: 'DETER',
        src_deter_desc: 'Real-time deforestation alerts',
        src_mapbiomas_name: 'MapBiomas Alerts',
        src_mapbiomas_desc: 'Satellite-based deforestation alerts',
        ...
        src_queimadas_name: 'Fire Hotspots',
        src_queimadas_desc: 'Satellite-detected active fires',
        src_hidro_name: 'Hydrography',
        src_hidro_desc: 'Riparian buffer zones (30m)',
        src_floresta_name: 'Public Forests',
        src_floresta_desc: 'National Public Forest Registry',
        src_concessao_name: 'Forest Concessions',
        src_concessao_desc: 'Forest concession areas',
        src_sicar_name: 'CAR/SICAR',
        src_sicar_desc: 'Rural Environmental Registry',
        src_pivos_name: 'Irrigation Pivots',
        src_pivos_desc: 'Center-pivot irrigation mapping',
        ...
        method_process_desc: 'PostGIS + 13 layers',
        ...
        method_step2_detail: 'PostGIS cross-checks against 13 official databases simultaneously.',
